        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              SafariDesk PM's property management software helps manage, grow, and automate hundreds of thousands of
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <Link href="/features" className="text-sm font-semibold leading-6 flex items-center gap-1 text-primary">
          ...
          <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
              {features.map((feature) => (
                <div key={feature.name} className="flex flex-col feature-gradient rounded-xl p-6">
      ...
      <section className="py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              Join thousands of property managers who have streamlined their operations with SafariDesk PM.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Link href="/request-demo">
                <Button
